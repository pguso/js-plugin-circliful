    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if(settings.targetPercent > 0) {
                ...
                elements += '<circle cx="100" cy="100" r="69" fill="none" stroke="' + settings.targetColor + '" stroke-width="3" stroke-dasharray="' + (180 / 100 * settings.targetPercent) + ', 20000" transform="rotate(-90,100,100)" />';
            ...
            circleContainer
                ...
                .append(
                    $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                        elements +
                        '<circle cx="100" cy="100" r="57" class="border" fill="' + settings.fillColor + '" stroke="' + settings.backgroundColor + '" stroke-width="' + backgroundBorderWidth + '" stroke-dasharray="180" transform="rotate(' + settings.startPoint + ',100,100)" />' +
                        '<circle class="circle" cx="100" cy="100" r="57" class="border" fill="none" stroke="' + settings.foregroundColor + '" stroke-width="' + settings.foregroundBorderWidth + '" stroke-dasharray="0,20000" transform="rotate(' + settings.startPoint + ',100,100)" />' +
            ...
            if (settings.animation == 1) {
                ...
                circle
                    .attr("stroke-dasharray", (180 / 100 * percent) + ", 20000");
